...
through the [rtools](https://www.ncrna.org/rtools/) web server for RNA Bioinformatics [@hamada2016]. 
...
```{r tidy = TRUE, tidy.opts=list(width.cutoff = 80), eval = FALSE}
...
with the MC-Fold algorithm, available through the
"predictAlternativeSecondaryStructures" function.

```{r tidy = TRUE, eval = FALSE}
tRNAfragment2 <- "AAAGGGGUUUCCC"

alternativePrediction <- predictAlternativeSecondaryStructures(tRNAfragment2)

length(alternativePrediction) # Number of alternative secondary structures identified

alternativePrediction[[1]]$secondaryStructure
```
